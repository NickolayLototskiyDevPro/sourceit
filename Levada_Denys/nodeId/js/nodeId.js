...
function nodeId() {
    ...
    for (var globeCount = 0; globeCount < arguments.length; globeCount++) {
        ...
        propname = 'Id: ' + (globeCount + 1);
        nodeObject[propname] = 'Object ' + arguments[globeCount].__proto__.constructor.name + ' father is : ' + father[globeCount];
    }
...
var nodeObjectJSON = JSON.stringify(nodeObject);
console.log(nodeObjectJSON);
