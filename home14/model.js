function BaseTank(){
	...
	this.init=function(newAmmunition, newfuel){
		this.fuel=newfuel;
...
function mapBase(){
	...
	this.onScreen=function(idNum){
		...
		var el=document.getElementById(idNum),
			...
			//alert('x '+getPosition.posX+'y='+getPosition.posY );
...
var currentTank=new Tank35(),
	currentGame=new ClassGame(false),
